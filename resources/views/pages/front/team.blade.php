    ...
    <div class="container">
        ...
        <div class="row">
            ...
            {{-- <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
                <div class="person text-center bg-white p-4">
                    ...
                    <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi at
                        consequatur unde molestiae quidem provident voluptatum deleniti quo iste error eos est
            ...
            <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
                <div class="person text-center bg-white p-4">
                    <img src="{{ asset('front/images/person_3.jpg') }}" alt="Image"
                        class="img-fluid rounded-circle mb-3">
                    <h3>Tom Sharp</h3>
            ...
            <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
                <div class="person text-center bg-white p-4">
                    <img src="{{ asset('front/images/person_4.jpg') }}" alt="Image"
                        class="img-fluid rounded-circle mb-3">
